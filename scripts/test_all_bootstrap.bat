...
set "TEST_FILES=examples\test_bootstrap_lexer.kb examples\test_bootstrap_ast.kb examples\test_bootstrap_parser.kb examples\test_bootstrap_sema_types.kb examples\test_bootstrap_sema_symbol.kb"
